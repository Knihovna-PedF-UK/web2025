...
local mainmenu = menulib()
  mainmenu:add("Služby","sluzby.htm")
    ...
    :addchild("Přístup k el.informačním zdrojům")
  ...
  :add("Naše prostory", "prostory.html")
    :addchild("Studovny")
      :addchild("Studovna v Rettigové 1",  "studovna.html")
      :addchild("Studovna v Rettigové 2","vypujcni_protokol.html")
  ...
  :add("Sbírky a zdroje", "sbirky.html")
    :addchild("Katalogy a databáze")
      :addchild("Discovery systém UKAŽ", "https://ukaz.cuni.cz/")
      ...
      :addchild("Meziknihovní výpůjční služba", "meziknih.htm")
      :addchild("Navrhuji koupit do fondu", "objednavani_liter.htm")
      :addchild("Nové knihy", 
    ...
    :add("Odborné práce", "odborne_prace.html") -- < 
      :addchild("Pomoc s tvorbou odborných prací")
        :addchild("Jak psát odborné práce", "kvalifikacni_prace.htm")
        :addchild("Pomoc s tvorbou citací", "inform_vzdelavani.htm")
      :addchild("Pro vyučující")
        :addchild("Pro vyučující", "biblio.html")
      :addchild("Studenti se speciálními potřebami")
        :addchild("Služby pro studenty s SP", "handi.htm")
...
engmenu:add("Services", "services.html")
  ...
  :add("Our Facilities", "spaces.html")
    :addchild("Study Rooms")
      :addchild("Study Room Rettigová 1",  "study-room.html")
      :addchild("Study Room Rettigová 2", "reference-desk.html")
